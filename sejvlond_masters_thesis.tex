...
\include{chapters/seznam-nowadays}
\include{chapters/what-is-kubernetes}
\include{chapters/what-is-docker}
\include{chapters/kubernetes-basic-concepts}
\include{chapters/kubernetes-architecture}
\include{chapters/possible-problems-with-kubernetes-in-seznam-cz}
\include{chapters/running-kubernetes}
\include{chapters/docker-registry}
\include{chapters/secrets-distribution}
\include{chapters/logging}
\include{chapters/security}
\include{chapters/monitoring}
\include{chapters/static-webpages-content}
\include{chapters/testing-application}
\include{chapters/testing-the-cluster}
\include{chapters/benchmarking-python-and-go-application-servers}
\include{chapters/benefits-for-seznam}
